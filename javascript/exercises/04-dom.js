// Exercise #1:
// description: when the user clicks the 'copy' button, copy the user input to the output area
...
// Exercise #2:
// description: when the user enters input text, copy the user input to the output area
